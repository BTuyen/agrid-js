 ...
 */
const getMethodReleaseTag = (apiMethod) => releaseTagMap[apiMethod.releaseTag] || 'public'

// Deprecation detection functions
const hasDeprecatedBlock = (apiMethod) => apiMethod.tsdocComment?.deprecatedBlock !== undefined
