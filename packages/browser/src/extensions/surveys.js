...
function getNextSurveyStep(survey, currentQuestionIndex, response) {
    ...
    if (question.branching.type === posthog_surveys_types_1.SurveyQuestionBranchingType.End) {
        ...
        if (question.type === posthog_surveys_types_1.SurveyQuestionType.SingleChoice) {
            ...
            if (
                (_c = (_b = question.branching) === null || _b === void 0 ? void 0 : _b.responseValues) === null ||
                _c === void 0
                    ? void 0
                    : _c.hasOwnProperty(selectedChoiceIndex)
            ) {
            ...
            if (
                (_e = (_d = question.branching) === null || _d === void 0 ? void 0 : _d.responseValues) === null ||
                _e === void 0
                    ? void 0
                    : _e.hasOwnProperty(ratingBucket)
            ) {
...
var SurveyManager = /** @class */ (function () {
    function SurveyManager(posthog) {
        ...
        this.handlePopoverSurvey = function (survey) {
            ...
            var timeoutId = setTimeout(function () {
                ...
                Preact.render(
                    (0, jsx_runtime_1.jsx)(SurveyPopup, {
                        posthog: _this._posthog,
                        survey: __assign(__assign({}, survey), {
                            appearance: __assign(__assign({}, survey.appearance), { surveyPopupDelaySeconds: 0 }),
                        }),
                        removeSurveyFromFocus: _this._removeSurveyFromFocus,
                    }),
                    shadow
        ...
        this._handleWidget = function (survey) {
            ...
            var _a = (0, surveys_extension_utils_1.retrieveSurveyShadow)(survey, _this._posthog),
                shadow = _a.shadow,
                isNewlyCreated = _a.isNewlyCreated
            // If the widget is already rendered, do nothing. Otherwise the widget will be re-rendered every second
            if (!isNewlyCreated) {
                return
            }
            Preact.render(
                (0, jsx_runtime_1.jsx)(FeedbackWidget, { posthog: _this._posthog, survey: survey }, survey.id),
                shadow
            )
        }
        ...
        this._manageWidgetSelectorListener = function (survey, selector) {
            ...
            if (existingListenerData) {
                ...
                if (currentElement !== existingListenerData.element) {
                    survey_utils_1.SURVEY_LOGGER.info(
                        'Selector element changed for survey '.concat(survey.id, '. Re-attaching listener.')
                    )
                    _this._removeWidgetSelectorListener(survey)
            ...
            if (!currentElement.hasAttribute(WIDGET_LISTENER_ATTRIBUTE)) {
                var listener = function (event) {
                    ...
                    var positionStyles =
                        ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.position) ===
                        posthog_surveys_types_1.SurveyPosition.NextToTrigger
                            ? getNextToTriggerPosition(
                                  event.currentTarget,
                                  parseInt(
                                      ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.maxWidth) ||
                                          surveys_extension_utils_1.defaultSurveyAppearance.maxWidth
                                  )
                              )
                            : {}
                ...
                _this._widgetSelectorListeners.set(survey.id, {
                    element: currentElement,
                    listener: listener,
                    survey: survey,
                })
                survey_utils_1.SURVEY_LOGGER.info(
                    'Attached click listener for feedback button survey '.concat(survey.id)
                )
            }
        }
        ...
        this.renderSurvey = function (survey, selector) {
            var _a, _b
            if (
                (_b = (_a = _this._posthog.config) === null || _a === void 0 ? void 0 : _a.surveys) === null ||
                _b === void 0
                    ? void 0
                    : _b.prefillFromUrl
            ) {
        ...
        this.getActiveMatchingSurveys = function (callback, forceReload) {
            ...
            ;(_a = _this._posthog) === null || _a === void 0
                ? void 0
                : _a.surveys.getSurveys(function (surveys) {
        ...
        this.callSurveysAndEvaluateDisplayLogic = function (forceReload) {
            ...
            _this.getActiveMatchingSurveys(function (surveys) {
                var inAppSurveysWithDisplayLogic = surveys.filter(function (survey) {
                    return (
                        survey.type === posthog_surveys_types_1.SurveyType.Popover ||
                        survey.type === posthog_surveys_types_1.SurveyType.Widget
                    )
                })
                    ...
                    if (survey.type === posthog_surveys_types_1.SurveyType.Widget) {
                        ...
                        if (
                            ((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.widgetType) ===
                                posthog_surveys_types_1.SurveyWidgetType.Selector &&
                            ((_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetSelector)
                        ) {
                            activeSelectorSurveys.add(survey.id)
                            _this._manageWidgetSelectorListener(
                                survey,
                                (_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.widgetSelector
                            )
                        }
                    }
                    // Popover Type Logic (only one shown at a time)
                    if (
                        (0, core_1.isNull)(_this._surveyInFocus) &&
                        survey.type === posthog_surveys_types_1.SurveyType.Popover
                    ) {
        ...
        this._addSurveyToFocus = function (survey) {
            if (!(0, core_1.isNull)(_this._surveyInFocus)) {
                survey_utils_1.SURVEY_LOGGER.error(
                    'Survey '
                        .concat(_this._surveyInFocus, ' already in focus. Cannot add survey ')
                        .concat(survey.id, '.')
                )
            }
        ...
        this._removeSurveyFromFocus = function (survey) {
            if (_this._surveyInFocus !== survey.id) {
                survey_utils_1.SURVEY_LOGGER.error(
                    'Survey '.concat(survey.id, ' is not in focus. Cannot remove survey ').concat(survey.id, '.')
                )
            }
            _this._clearSurveyTimeout(survey.id)
    ...
    SurveyManager.prototype._sortSurveysByAppearanceDelay = function (surveys) {
        return surveys.sort(function (a, b) {
            ...
            return (
                (((_a = a.appearance) === null || _a === void 0 ? void 0 : _a.surveyPopupDelaySeconds) || 0) -
                (((_b = b.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds) || 0)
            )
        })
    }
    SurveyManager.prototype._handleUrlPrefill = function (survey) {
        ...
        try {
            var _b = (0, survey_url_prefill_1.extractPrefillParamsFromUrl)(window.location.search),
                params = _b.params,
                autoSubmit = _b.autoSubmit
    ...
    SurveyManager.prototype._scheduleAutoSubmit = function (survey, responses, submissionId) {
        ...
        var _a, _b
        var delay =
            (_b = (_a = this._posthog.config.surveys) === null || _a === void 0 ? void 0 : _a.autoSubmitDelay) !==
                null && _b !== void 0
                ? _b
                : 800
    ...
    SurveyManager.prototype._isSurveyConditionMatched = function (survey) {
        ...
        return (
            (0, surveys_extension_utils_1.doesSurveyUrlMatch)(survey) &&
    ...
    SurveyManager.prototype._internalFlagCheckSatisfied = function (survey) {
        return (
            (0, surveys_extension_utils_1.canActivateRepeatedly)(survey) ||
    ...
    SurveyManager.prototype.checkSurveyEligibility = function (survey) {
        ...
        if (
            !(0, surveys_extension_utils_1.hasWaitPeriodPassed)(
                (_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.seenSurveyWaitPeriodInDays
            )
        ) {
            eligibility.eligible = false
    ...
    SurveyManager.prototype._hasActionOrEventTriggeredSurvey = function (survey) {
        var _a
        if (
            !(0, survey_utils_1.doesSurveyActivateByEvent)(survey) &&
            !(0, survey_utils_1.doesSurveyActivateByAction)(survey)
        ) {
            // If survey doesn't depend on events/actions, it's considered "triggered" by default
            return true
        }
        var surveysActivatedByEventsOrActions =
            (_a = this._posthog.surveys._surveyEventReceiver) === null || _a === void 0 ? void 0 : _a.getSurveys()
        return !!(surveysActivatedByEventsOrActions === null || surveysActivatedByEventsOrActions === void 0
            ? void 0
            : surveysActivatedByEventsOrActions.includes(survey.id))
    }
    ...
    SurveyManager.prototype._removeSurveyFromDom = function (survey) {
        try {
            var shadowContainer = document.querySelector(
                (0, surveys_extension_utils_1.getSurveyContainerClass)(survey, true)
            )
...
var renderSurveysPreview = function (_a) {
    var survey = _a.survey,
        ...
        previewPageIndex = _a.previewPageIndex,
        forceDisableHtml = _a.forceDisableHtml,
        onPreviewSubmit = _a.onPreviewSubmit,
        _b = _a.positionStyles,
        positionStyles = _b === void 0 ? DEFAULT_PREVIEW_POSITION_STYLES : _b
...
var renderFeedbackWidgetPreview = function (_a) {
    ...
    Preact.render(
        (0, jsx_runtime_1.jsx)(FeedbackWidget, { forceDisableHtml: forceDisableHtml, survey: survey, readOnly: true }),
        root
    )
}
...
function useHideSurveyOnURLChange(_a) {
    var survey = _a.survey,
        _b = _a.removeSurveyFromFocus,
        removeSurveyFromFocus = _b === void 0 ? function () {} : _b,
        setSurveyVisible = _a.setSurveyVisible,
        _c = _a.isPreviewMode,
        isPreviewMode = _c === void 0 ? false : _c
    ;(0, hooks_1.useEffect)(
        function () {
            var _a
            ...
            var checkUrlMatch = function () {
                ...
                var isSurveyWidgetTypeTab =
                    ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.widgetType) ===
                        posthog_surveys_types_1.SurveyWidgetType.Tab && isSurveyTypeWidget
                if (doesSurveyMatchUrlCondition) {
                    if (isSurveyWidgetTypeTab) {
                        survey_utils_1.SURVEY_LOGGER.info(
                            'Showing survey '.concat(survey.id, ' because it is a feedback button tab and URL matches')
                        )
...
function usePopupVisibility(
    ...
    var _a = __read(
            (0, hooks_1.useState)(
                isPreviewMode ||
                    millisecondDelay === 0 ||
                    survey.type === posthog_surveys_types_1.SurveyType.ExternalSurvey
            ),
            2
        ),
        isPopupVisible = _a[0],
        setIsPopupVisible = _a[1]
    var _b = __read((0, hooks_1.useState)(false), 2),
        isSurveySent = _b[0],
        setIsSurveySent = _b[1]
    var hidePopupWithViewTransition = function () {
        ...
        var transition = document.startViewTransition(function () {
            var _a
            ;(_a =
                surveyContainerRef === null || surveyContainerRef === void 0 ? void 0 : surveyContainerRef.current) ===
                null || _a === void 0
                ? void 0
                : _a.remove()
        })
    ...
    ;(0, hooks_1.useEffect)(function () {
        ...
        var showSurvey = function () {
            ...
            posthog.capture(
                posthog_surveys_types_1.SurveyEventName.SHOWN,
                ((_a = {}),
                ...
                (_a.sessionRecordingUrl =
                    (_b = posthog.get_session_replay_url) === null || _b === void 0 ? void 0 : _b.call(posthog)),
                _a)
            )
    ...
    return {
        ...
        hidePopupWithViewTransition: hidePopupWithViewTransition,
    }
}
        ...
        case posthog_surveys_types_1.SurveyPosition.Right:
            return {
                right:
                    ...
                    surveyWidgetType === posthog_surveys_types_1.SurveyWidgetType.Tab
                        ? '60px'
                        : '30px',
            }
    }
...
function SurveyPopup(_a) {
    ...
    var survey = _a.survey,
        ...
        style = _h === void 0 ? {} : _h,
        previewPageIndex = _a.previewPageIndex,
        _j = _a.removeSurveyFromFocus,
        removeSurveyFromFocus = _j === void 0 ? function () {} : _j,
        _k = _a.isPopup,
        isPopup = _k === void 0 ? true : _k,
        _l = _a.onPreviewSubmit,
        onPreviewSubmit = _l === void 0 ? function () {} : _l,
        _m = _a.onPopupSurveyDismissed,
        onPopupSurveyDismissed = _m === void 0 ? function () {} : _m,
        _o = _a.onCloseConfirmationMessage,
        onCloseConfirmationMessage = _o === void 0 ? function () {} : _o
    ...
    var surveyPopupDelayMilliseconds = (
        (_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.surveyPopupDelaySeconds
    )
        ? survey.appearance.surveyPopupDelaySeconds * 1000
        : 0
    var _p = usePopupVisibility(
            survey,
            posthog,
        ...
        isPopupVisible = _p.isPopupVisible,
        isSurveySent = _p.isSurveySent,
        hidePopupWithViewTransition = _p.hidePopupWithViewTransition
    var shouldShowConfirmation = isSurveySent || previewPageIndex === survey.questions.length
    var surveyContextValue = (0, hooks_1.useMemo)(
        function () {
            ...
            return {
                ...
                surveySubmissionId:
                    (getInProgressSurvey === null || getInProgressSurvey === void 0
                        ? void 0
                        : getInProgressSurvey.surveySubmissionId) || (0, uuidv7_1.uuidv7)(),
                onPreviewSubmit: onPreviewSubmit,
                posthog: posthog,
            }
        },
    ...
    return (0, jsx_runtime_1.jsx)(surveys_extension_utils_1.SurveyContext.Provider, {
        ...
        children: (0, jsx_runtime_1.jsx)('div', {
            ...
            style: __assign(
                __assign(
                    ...
                    getPopoverPosition(
                        survey.type,
                        (_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.position,
                        (_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.widgetType
                    )
                ),
                style
            ),
            ...
            children: !shouldShowConfirmation
                ? (0, jsx_runtime_1.jsx)(Questions, {
                      survey: survey,
                      forceDisableHtml: !!forceDisableHtml,
                      posthog: posthog,
                  })
                : (0, jsx_runtime_1.jsx)(ConfirmationMessage_1.ConfirmationMessage, {
                      header:
                          ((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.thankYouMessageHeader) ||
                          'Thank you!',
                      description:
                          ((_f = survey.appearance) === null || _f === void 0
                              ? void 0
                              : _f.thankYouMessageDescription) || '',
                      forceDisableHtml: !!forceDisableHtml,
                      contentType:
                          (_g = survey.appearance) === null || _g === void 0
                              ? void 0
                              : _g.thankYouMessageDescriptionContentType,
...
function Questions(_a) {
    ...
    var _b = __read(
            (0, hooks_1.useState)(function () {
                var inProgressSurveyData = (0, surveys_extension_utils_1.getInProgressSurveyState)(survey)
                if (
                    inProgressSurveyData === null || inProgressSurveyData === void 0
                        ? void 0
                        : inProgressSurveyData.responses
                ) {
        ...
        questionsResponses = _b[0],
        setQuestionsResponses = _b[1]
    var _c = (0, hooks_1.useContext)(surveys_extension_utils_1.SurveyContext),
        previewPageIndex = _c.previewPageIndex,
        onPopupSurveyDismissed = _c.onPopupSurveyDismissed,
        isPopup = _c.isPopup,
        onPreviewSubmit = _c.onPreviewSubmit,
        surveySubmissionId = _c.surveySubmissionId,
    ...
    var _d = __read(
            (0, hooks_1.useState)(function () {
                ...
                return (
                    ...
                    (inProgressSurveyData === null || inProgressSurveyData === void 0
                        ? void 0
                        : inProgressSurveyData.lastQuestionIndex) ||
                    0
                )
            }),
            2
        ),
        currentQuestionIndex = _d[0],
        setCurrentQuestionIndex = _d[1]
    var surveyQuestions = (0, hooks_1.useMemo)(
        function () {
            return (0, surveys_extension_utils_1.getDisplayOrderQuestions)(survey)
        },
        [survey]
    )
    // Sync preview state
    ...
    var onNextButtonClick = function (_a) {
        var _b
        var res = _a.res,
            displayQuestionIndex = _a.displayQuestionIndex,
            questionId = _a.questionId
        if (!posthog) {
...
function FeedbackWidget(_a) {
    ...
    var _g = __read((0, hooks_1.useState)(true), 2),
        isFeedbackButtonVisible = _g[0],
        setIsFeedbackButtonVisible = _g[1]
    var _h = __read((0, hooks_1.useState)(false), 2),
        showSurvey = _h[0],
        setShowSurvey = _h[1]
    var _j = __read((0, hooks_1.useState)({}), 2),
        styleOverrides = _j[0],
        setStyleOverrides = _j[1]
        ...
        function () {
            ...
            var handleShowSurvey = function (event) {
                ...
                if (((_a = customEvent.detail) === null || _a === void 0 ? void 0 : _a.surveyId) === survey.id) {
                    survey_utils_1.SURVEY_LOGGER.info(
                        'Received show event for feedback button survey '.concat(survey.id)
                    )
    ...
    return (0, jsx_runtime_1.jsxs)(Preact.Fragment, {
        children: [
            ((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.widgetType) === 'tab' &&
                (0, jsx_runtime_1.jsx)('button', {
                    ...
                    disabled: readOnly,
                    children: ((_f = survey.appearance) === null || _f === void 0 ? void 0 : _f.widgetLabel) || '',
                }),
            showSurvey &&
                (0, jsx_runtime_1.jsx)(SurveyPopup, {
                    posthog: posthog,
    ...
    switch (question.type) {
        case posthog_surveys_types_1.SurveyQuestionType.Open:
            return (0, react_1.createElement)(
                QuestionTypes_1.OpenTextQuestion,
                __assign({}, baseProps, { question: question, key: question.id })
            )
        case posthog_surveys_types_1.SurveyQuestionType.Link:
            return (0, react_1.createElement)(
                QuestionTypes_1.LinkQuestion,
                __assign({}, baseProps, { question: question, key: question.id })
            )
        case posthog_surveys_types_1.SurveyQuestionType.Rating:
            return (0, react_1.createElement)(
                QuestionTypes_1.RatingQuestion,
                __assign({}, baseProps, { question: question, key: question.id })
            )
        ...
        case posthog_surveys_types_1.SurveyQuestionType.MultipleChoice:
            return (0, react_1.createElement)(
                QuestionTypes_1.MultipleChoiceQuestion,
                __assign({}, baseProps, { question: question, key: question.id })
            )
        default:
