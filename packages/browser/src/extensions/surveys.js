...
import { SurveyEventName, SurveyEventProperties, SurveyPosition, SurveyQuestionBranchingType, SurveyQuestionType, SurveySchedule, SurveyType, SurveyWidgetType, } from '../posthog-surveys-types';
import { addEventListener } from '../utils';
import { document as _document, window as _window } from '../utils/globals';
import { doesSurveyActivateByAction, doesSurveyActivateByEvent, IN_APP_SURVEY_TYPES, isSurveyRunning, SURVEY_LOGGER as logger, } from '../utils/survey-utils';
...
import { extractPrefillParamsFromUrl, convertPrefillToResponses, allRequiredQuestionsFilled, } from '../utils/survey-url-prefill';
...
export class SurveyManager {
    constructor(posthog) {
        ...
        this.handlePopoverSurvey = (survey) => {
            ...
            const delaySeconds = ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.surveyPopupDelaySeconds) || 0;
            const { shadow } = retrieveSurveyShadow(survey, this._posthog);
            if (delaySeconds <= 0) {
                return Preact.render(_jsx(SurveyPopup, { posthog: this._posthog, survey: survey, removeSurveyFromFocus: this._removeSurveyFromFocus }), shadow);
            }
            const timeoutId = setTimeout(() => {
                ...
                Preact.render(_jsx(SurveyPopup, { posthog: this._posthog, survey: { ...survey, appearance: { ...survey.appearance, surveyPopupDelaySeconds: 0 } }, removeSurveyFromFocus: this._removeSurveyFromFocus }), shadow);
            }, delaySeconds * 1000);
        ...
        this._handleWidget = (survey) => {
            ...
            Preact.render(_jsx(FeedbackWidget, { posthog: this._posthog, survey: survey }, survey.id), shadow);
        };
        ...
        this._manageWidgetSelectorListener = (survey, selector) => {
            ...
            if (!currentElement.hasAttribute(WIDGET_LISTENER_ATTRIBUTE)) {
                const listener = (event) => {
                    ...
                    const positionStyles = ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.position) === SurveyPosition.NextToTrigger
                        ? getNextToTriggerPosition(event.currentTarget, parseInt(((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.maxWidth) || defaultSurveyAppearance.maxWidth))
                        : {};
        ...
        this.renderPopover = (survey) => {
            const { shadow } = retrieveSurveyShadow(survey, this._posthog);
            Preact.render(_jsx(SurveyPopup, { posthog: this._posthog, survey: survey, removeSurveyFromFocus: this._removeSurveyFromFocus }), shadow);
        };
        this.renderSurvey = (survey, selector) => {
            var _a, _b;
            if ((_b = (_a = this._posthog.config) === null || _a === void 0 ? void 0 : _a.surveys) === null || _b === void 0 ? void 0 : _b.prefillFromUrl) {
                this._handleUrlPrefill(survey);
            }
            Preact.render(_jsx(SurveyPopup, { posthog: this._posthog, survey: survey, removeSurveyFromFocus: this._removeSurveyFromFocus, isPopup: false }), selector);
        };
        this.getActiveMatchingSurveys = (callback, forceReload = false) => {
            var _a;
            (_a = this._posthog) === null || _a === void 0 ? void 0 : _a.surveys.getSurveys((surveys) => {
        ...
        this.callSurveysAndEvaluateDisplayLogic = (forceReload = false) => {
            this.getActiveMatchingSurveys((surveys) => {
                const inAppSurveysWithDisplayLogic = surveys.filter((survey) => survey.type === SurveyType.Popover || survey.type === SurveyType.Widget);
                ...
                const activeSelectorSurveys = new Set();
                inAppSurveysQueue.forEach((survey) => {
                    ...
                    if (survey.type === SurveyType.Widget) {
                        ...
                        if (((_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.widgetType) === SurveyWidgetType.Selector &&
                            ((_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetSelector)) {
                            activeSelectorSurveys.add(survey.id);
                            this._manageWidgetSelectorListener(survey, (_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.widgetSelector);
                        }
                    }
        ...
        this._removeSurveyFromFocus = (survey) => {
     ...
     */
    _sortSurveysByAppearanceDelay(surveys) {
    ...
    _scheduleAutoSubmit(survey, responses, submissionId) {
        var _a, _b;
        const delay = (_b = (_a = this._posthog.config.surveys) === null || _a === void 0 ? void 0 : _a.autoSubmitDelay) !== null && _b !== void 0 ? _b : 800;
    ...
    _isSurveyFeatureFlagEnabled(flagKey, flagVariant = undefined) {
        if (!flagKey) {
            return true;
        }
    ...
    checkSurveyEligibility(survey) {
        var _a, _b;
        const eligibility = { eligible: true, reason: undefined };
        ...
        const linkedFlagVariant = (_a = survey.conditions) === null || _a === void 0 ? void 0 : _a.linkedFlagVariant;
        ...
        if (!hasWaitPeriodPassed((_b = survey.conditions) === null || _b === void 0 ? void 0 : _b.seenSurveyWaitPeriodInDays)) {
            eligibility.eligible = false;
     ...
     * @param survey
     */
    _hasActionOrEventTriggeredSurvey(survey) {
        var _a;
        ...
        const surveysActivatedByEventsOrActions = (_a = this._posthog.surveys._surveyEventReceiver) === null || _a === void 0 ? void 0 : _a.getSurveys();
...
const DEFAULT_PREVIEW_POSITION_STYLES = {
    position: 'relative',
    left: 'unset',
    right: 'unset',
    top: 'unset',
...
export const renderSurveysPreview = ({ survey, parentElement, previewPageIndex, forceDisableHtml, onPreviewSubmit, positionStyles = DEFAULT_PREVIEW_POSITION_STYLES, }) => {
    ...
    Preact.render(_jsx(SurveyPopup, { survey: survey, forceDisableHtml: forceDisableHtml, style: positionStyles, onPreviewSubmit: onPreviewSubmit, previewPageIndex: previewPageIndex, removeSurveyFromFocus: () => { } }), parentElement);
};
export const renderFeedbackWidgetPreview = ({ survey, root, forceDisableHtml, }) => {
    const stylesheet = getSurveyStylesheet();
    if (stylesheet) {
        root.appendChild(stylesheet);
        addSurveyCSSVariablesToElement(root, survey.type, survey.appearance);
    }
    Preact.render(_jsx(FeedbackWidget, { forceDisableHtml: forceDisableHtml, survey: survey, readOnly: true }), root);
};
// This is the main exported function
export function generateSurveys(posthog, isSurveysEnabled) {
 ...
 */
export function useHideSurveyOnURLChange({ survey, removeSurveyFromFocus = () => { }, setSurveyVisible, isPreviewMode = false, }) {
    useEffect(() => {
        var _a;
        ...
        const checkUrlMatch = () => {
            ...
            const isSurveyWidgetTypeTab = ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.widgetType) === SurveyWidgetType.Tab && isSurveyTypeWidget;
...
export function usePopupVisibility(survey, posthog, millisecondDelay, isPreviewMode, removeSurveyFromFocus, surveyContainerRef) {
    const [isPopupVisible, setIsPopupVisible] = useState(isPreviewMode || millisecondDelay === 0 || survey.type === SurveyType.ExternalSurvey);
    ...
    const handleSurveyClosed = (event) => {
...
function getPopoverPosition(type, position = SurveyPosition.Right, surveyWidgetType) {
...
export function SurveyPopup({ survey, forceDisableHtml, posthog, style = {}, previewPageIndex, removeSurveyFromFocus = () => { }, isPopup = true, onPreviewSubmit = () => { }, onPopupSurveyDismissed = () => { }, onCloseConfirmationMessage = () => { }, }) {
    ...
    const surveyPopupDelayMilliseconds = ((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.surveyPopupDelaySeconds)
        ? survey.appearance.surveyPopupDelaySeconds * 1000
        : 0;
    const { isPopupVisible, isSurveySent, hidePopupWithViewTransition } = usePopupVisibility(survey, posthog, surveyPopupDelayMilliseconds, isPreviewMode, removeSurveyFromFocus, surveyContainerRef);
    ...
    return (_jsx(SurveyContext.Provider, { value: surveyContextValue, children: _jsx("div", { className: "ph-survey", style: {
                ...getPopoverPosition(survey.type, (_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.position, (_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetType),
                ...style,
            }, ref: surveyContainerRef, children: !shouldShowConfirmation ? (_jsx(Questions, { survey: survey, forceDisableHtml: !!forceDisableHtml, posthog: posthog })) : (_jsx(ConfirmationMessage, { header: ((_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.thankYouMessageHeader) || 'Thank you!', description: ((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.thankYouMessageDescription) || '', forceDisableHtml: !!forceDisableHtml, contentType: (_f = survey.appearance) === null || _f === void 0 ? void 0 : _f.thankYouMessageDescriptionContentType, appearance: survey.appearance || defaultSurveyAppearance, onClose: () => {
                    hidePopupWithViewTransition();
                    onCloseConfirmationMessage();
                } })) }) }));
}
export function Questions({ survey, forceDisableHtml, posthog, }) {
    ...
    const { previewPageIndex, onPopupSurveyDismissed, isPopup, onPreviewSubmit, surveySubmissionId, isPreviewMode } = useContext(SurveyContext);
    ...
    const onNextButtonClick = ({ res, displayQuestionIndex, questionId, }) => {
        if (!posthog) {
    ...
    return (_jsxs("form", { className: "survey-form", name: "surveyForm", children: [isPopup && (_jsx(Cancel, { onClick: () => {
                    onPopupSurveyDismissed();
                } })), _jsx("div", { className: "survey-box", children: getQuestionComponent({
...
export function FeedbackWidget({ survey, forceDisableHtml, posthog, readOnly, }) {
    var _a, _b, _c, _d, _e;
    ...
    useEffect(() => {
        ...
        readOnly,
        survey.id,
        (_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.widgetType,
        (_b = survey.appearance) === null || _b === void 0 ? void 0 : _b.widgetSelector,
        (_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.borderColor,
    ]);
    useHideSurveyOnURLChange({
        survey,
    ...
    return (_jsxs(Preact.Fragment, { children: [((_d = survey.appearance) === null || _d === void 0 ? void 0 : _d.widgetType) === 'tab' && (_jsx("button", { className: "ph-survey-widget-tab", onClick: toggleSurvey, disabled: readOnly, children: ((_e = survey.appearance) === null || _e === void 0 ? void 0 : _e.widgetLabel) || '' })), showSurvey && (_jsx(SurveyPopup, { posthog: posthog, survey: survey, forceDisableHtml: forceDisableHtml, style: styleOverrides, onPopupSurveyDismissed: resetShowSurvey, onCloseConfirmationMessage: resetShowSurvey }))] }));
}
const getQuestionComponent = ({ question, forceDisableHtml, displayQuestionIndex, appearance, onSubmit, onPreviewSubmit, initialValue, }) => {
    const baseProps = {
        forceDisableHtml,
        appearance,
        onPreviewSubmit: (res) => {
    ...
    switch (question.type) {
        case SurveyQuestionType.Open:
            return _createElement(OpenTextQuestion, { ...baseProps, question: question, key: question.id });
        case SurveyQuestionType.Link:
            return _createElement(LinkQuestion, { ...baseProps, question: question, key: question.id });
        case SurveyQuestionType.Rating:
            return _createElement(RatingQuestion, { ...baseProps, question: question, key: question.id });
        case SurveyQuestionType.SingleChoice:
        case SurveyQuestionType.MultipleChoice:
            return _createElement(MultipleChoiceQuestion, { ...baseProps, question: question, key: question.id });
        default:
