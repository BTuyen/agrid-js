...
export declare function getNextSurveyStep(
    survey: Survey,
...
export declare const renderSurveysPreview: ({
    survey,
    parentElement,
    previewPageIndex,
    forceDisableHtml,
...
export declare const renderFeedbackWidgetPreview: ({
    survey,
    root,
    forceDisableHtml,
}: {
...
export declare function generateSurveys(
    posthog: PostHog,
    isSurveysEnabled: boolean | undefined
 ...
 */
export declare function useHideSurveyOnURLChange({
    survey,
    removeSurveyFromFocus,
    setSurveyVisible,
    isPreviewMode,
}: UseHideSurveyOnURLChangeProps): void
export declare function usePopupVisibility(
    survey: Survey,
...
export declare function SurveyPopup({
    survey,
    forceDisableHtml,
    posthog,
    style,
...
}: SurveyPopupProps): JSX.Element | null
export declare function Questions({
    survey,
    forceDisableHtml,
    posthog,
}: {
...
export declare function FeedbackWidget({
    survey,
    forceDisableHtml,
    posthog,
    readOnly,
