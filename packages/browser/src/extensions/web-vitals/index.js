...
export class WebVitalsAutocapture {
    constructor(_instance) {
        ...
        this._flushToCapture = () => {
            ...
            this._instance.capture('$web_vitals', this._buffer.metrics.reduce((acc, metric) => ({
                ...acc,
        ...
        this._addToBuffer = (metric) => {
            var _a;
            const sessionIds = (_a = this._instance.sessionManager) === null || _a === void 0 ? void 0 : _a.checkAndGetSessionAndWindowId(true);
        ...
        this._enabledServerSide = !!((_a = this._instance.persistence) === null || _a === void 0 ? void 0 : _a.props[WEB_VITALS_ENABLED_SERVER_SIDE]);
        this.startIfEnabled();
    }
    get allowedMetrics() {
        var _a, _b;
        const clientConfigMetricAllowList = isObject(this._instance.config.capture_performance)
        ...
        return !isUndefined(clientConfigMetricAllowList)
            ...
            : ((_b = this._instance.persistence) === null || _b === void 0 ? void 0 : _b.props[WEB_VITALS_ALLOWED_METRICS]) || ['CLS', 'FCP', 'INP', 'LCP'];
    }
    ...
    get _maxAllowedValue() {
        const configured = isObject(this._instance.config.capture_performance) &&
    ...
    get isEnabled() {
        ...
        const protocol = location === null || location === void 0 ? void 0 : location.protocol;
    ...
    _loadScript(cb) {
        ...
        (_c = (_b = assignableWindow.__PosthogExtensions__) === null || _b === void 0 ? void 0 : _b.loadExternalDependency) === null || _c === void 0 ? void 0 : _c.call(_b, this._instance, 'web-vitals', (err) => {
            if (err) {
