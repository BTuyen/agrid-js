...
function BottomSection(_a) {
    var text = _a.text,
        ...
        skipSubmitButton = _a.skipSubmitButton
        ...
        children: [
            !skipSubmitButton &&
                (0, jsx_runtime_1.jsx)('button', {
                    ...
                    onClick: function () {
                        if (link) {
                            globals_1.window === null || globals_1.window === void 0
                                ? void 0
                                : globals_1.window.open(link)
                        }
                        if (isPreviewMode) {
            ...
            !appearance.whiteLabel && (0, jsx_runtime_1.jsx)(PostHogLogo_1.PostHogLogo, {}),
        ],
    })
}
