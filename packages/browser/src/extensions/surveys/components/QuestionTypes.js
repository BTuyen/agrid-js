...
var isValidStringArray = function (value) {
    return (
        (0, core_1.isArray)(value) &&
        value.every(function (item) {
            return (0, core_1.isString)(item)
        })
    )
}
...
var initializeOpenEndedState = function (initialValue, choices) {
    ...
    if (isValidStringArray(initialValue)) {
        var openEndedValue = initialValue.find(function (choice) {
    ...
    return (0, jsx_runtime_1.jsxs)(preact_1.Fragment, {
        children: [
            (0, jsx_runtime_1.jsxs)('div', {
                ...
                children: [
                    (0, jsx_runtime_1.jsx)(QuestionHeader_1.QuestionHeader, {
                        question: question,
                    ...
                    (0, jsx_runtime_1.jsx)('textarea', {
                        ...
                        id: htmlFor,
                        rows: 4,
                        placeholder: appearance === null || appearance === void 0 ? void 0 : appearance.placeholder,
                        onInput: function (e) {
    ...
    return (0, jsx_runtime_1.jsxs)(preact_1.Fragment, {
        children: [
            (0, jsx_runtime_1.jsx)('div', {
                className: 'question-container',
                children: (0, jsx_runtime_1.jsx)(QuestionHeader_1.QuestionHeader, {
                    question: question,
                    forceDisableHtml: forceDisableHtml,
                }),
            }),
            (0, jsx_runtime_1.jsx)(BottomSection_1.BottomSection, {
                ...
                appearance: appearance,
                onSubmit: function () {
                    return onSubmit('link clicked')
                },
                onPreviewSubmit: function () {
                    return onPreviewSubmit('link clicked')
                },
            }),
        ],
    })
...
function RatingQuestion(_a) {
    ...
    var _b = __read(
            (0, hooks_1.useState)(function () {
                ...
                if (
                    (0, core_1.isArray)(initialValue) &&
                    initialValue.length > 0 &&
                    (0, core_1.isNumber)(parseInt(initialValue[0]))
                ) {
    ...
    return (0, jsx_runtime_1.jsxs)(preact_1.Fragment, {
        children: [
                    ...
                    (0, jsx_runtime_1.jsxs)('div', {
                        ...
                        children: [
                                ...
                                children: [
                                    question.display === 'emoji' &&
                                        (0, jsx_runtime_1.jsx)('div', {
                                            ...
                                            children: (question.scale === 3 ? threeScaleEmojis : fiveScaleEmojis).map(
                                                function (emoji, idx) {
                                                    var active = idx + 1 === rating
                                                    return (0, jsx_runtime_1.jsx)(
                                                        'button',
                                                        {
                                                            'aria-label': 'Rate '.concat(idx + 1),
                                                            className: 'ratings-emoji question-'
                                                                .concat(displayQuestionIndex, '-rating-')
                                                                .concat(idx, ' ')
                                                                .concat(active ? 'rating-active' : ''),
                                                            value: idx + 1,
                                                            type: 'button',
                                                            onClick: function () {
                                                                var response = idx + 1
                                    ...
                                    question.display === 'number' &&
                                        (0, jsx_runtime_1.jsx)('div', {
                                            ...
                                            children: getScaleNumbers(question.scale).map(function (number, idx) {
                                                ...
                                                return (0, jsx_runtime_1.jsx)(
                                                    RatingButton,
                                                    {
                                                        ...
                                                        appearance: appearance,
                                                        num: number,
                                                        setActiveNumber: function (response) {
                                                            setRating(response)
                                                            if (question.skipSubmitButton) {
                                                                handleSubmit(response)
                                                            }
                            ...
                            (0, jsx_runtime_1.jsxs)('div', {
                                ...
                                children: [
                                    (0, jsx_runtime_1.jsx)('div', { children: question.lowerBoundLabel }),
                                    (0, jsx_runtime_1.jsx)('div', { children: question.upperBoundLabel }),
                                ],
                            }),
                        ],
                    }),
            ...
            (0, jsx_runtime_1.jsx)(BottomSection_1.BottomSection, {
                text:
                    question.buttonText ||
                    (appearance === null || appearance === void 0 ? void 0 : appearance.submitButtonText) ||
                    'Submit',
                submitDisabled: (0, core_1.isNull)(rating) && !question.optional,
                appearance: appearance,
                onSubmit: function () {
                    return onSubmit(rating)
                },
                onPreviewSubmit: function () {
                    return onPreviewSubmit(rating)
                },
...
function RatingButton(_a) {
    var num = _a.num,
        active = _a.active,
        displayQuestionIndex = _a.displayQuestionIndex,
        setActiveNumber = _a.setActiveNumber
    return (0, jsx_runtime_1.jsx)('button', {
        'aria-label': 'Rate '.concat(num),
...
function MultipleChoiceQuestion(_a) {
    ...
    var choices = (0, hooks_1.useMemo)(
        function () {
            return (0, surveys_extension_utils_1.getDisplayOrderChoices)(question)
        },
        [question]
    )
    var _b = __read(
        ...
        selectedChoices = _b[0],
        setSelectedChoices = _b[1]
    var _c = __read(
            (0, hooks_1.useState)(function () {
    ...
    var handleChoiceChange = function (val, isOpenChoice) {
        if (isOpenChoice) {
            ...
            setOpenEndedState(function (prev) {
                return __assign(__assign({}, prev), {
                    isSelected: newOpenSelected_1,
                    inputValue: newOpenSelected_1 ? prev.inputValue : '',
                })
            })
            ...
            if (newOpenSelected_1) {
                setTimeout(function () {
                    var _a
                    return (_a = openChoiceInputRef.current) === null || _a === void 0 ? void 0 : _a.focus()
                }, 75)
            }
            return
        }
        if (isSingleChoiceQuestion) {
            ...
            setOpenEndedState(function (prev) {
                return __assign(__assign({}, prev), { isSelected: false, inputValue: '' })
            })
            if (shouldSkipSubmit) {
                onSubmit(val)
                if (isPreviewMode) {
        ...
        if (isMultipleChoiceQuestion && (0, core_1.isArray)(selectedChoices)) {
            if (selectedChoices.includes(val)) {
                setSelectedChoices(
                    selectedChoices.filter(function (choice) {
                        return choice !== val
                    })
                )
            } else {
    ...
    var handleOpenEndedInputChange = function (e) {
        ...
        setOpenEndedState(function (prev) {
            return __assign(__assign({}, prev), { inputValue: newValue })
        })
        if (isSingleChoiceQuestion) {
        ...
        if (openEndedState.isSelected && isMultipleChoiceQuestion) {
            if ((0, core_1.isArray)(selectedChoices)) {
                isPreviewMode
                    ? onPreviewSubmit(
                          __spreadArray(
                              __spreadArray([], __read(selectedChoices), false),
                              [openEndedState.inputValue],
                              false
                          )
                      )
                    : onSubmit(
                    ...
                    (0, jsx_runtime_1.jsxs)('fieldset', {
                        ...
                        children: [
                            (0, jsx_runtime_1.jsx)('legend', {
                                className: 'sr-only',
                                children: isMultipleChoiceQuestion ? ' Select all that apply' : ' Select one',
                            }),
                            choices.map(function (choice, idx) {
                                ...
                                return (0, jsx_runtime_1.jsxs)(
                                    'label',
                                    {
                                        className: isOpenChoice ? 'choice-option-open' : '',
                                        children: [
                                            (0, jsx_runtime_1.jsxs)('div', {
                                                ...
                                                children: [
                                                    (0, jsx_runtime_1.jsx)('input', {
                                                        ...
                                                        checked: isChecked,
                                                        onChange: function () {
                                                            return handleChoiceChange(choice, isOpenChoice)
                                                        },
                                                        id: inputId,
                                                        'aria-controls': openInputId,
                                                    }),
                                                    (0, jsx_runtime_1.jsx)('span', {
                                                        children: isOpenChoice ? ''.concat(choice, ':') : choice,
                                                    }),
                                                ],
                                            }),
                                            isOpenChoice &&
                                                (0, jsx_runtime_1.jsx)('input', {
                                                    ...
                                                    id: openInputId,
                                                    name: 'question'.concat(displayQuestionIndex, 'Open'),
...
var fiveScaleEmojis = [
    icons_1.veryDissatisfiedEmoji,
    icons_1.dissatisfiedEmoji,
    icons_1.neutralEmoji,
    icons_1.satisfiedEmoji,
    icons_1.verySatisfiedEmoji,
]
