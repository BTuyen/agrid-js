...
export class SessionIdManager {
    ...
    constructor(instance, sessionIdGenerator, windowIdGenerator) {
        ...
        this._sessionTimeoutMs =
            clampToRange(desiredTimeout, MIN_SESSION_IDLE_TIMEOUT_SECONDS, MAX_SESSION_IDLE_TIMEOUT_SECONDS, logger.createLogger('session_idle_timeout_seconds'), DEFAULT_SESSION_IDLE_TIMEOUT_SECONDS) * 1000;
    ...
    checkAndGetSessionAndWindowId(readOnly = false, _timestamp = null) {
        ...
        const activityTimeout = !noSessionId && !readOnly && this._sessionHasBeenIdleTooLong(timestamp, lastActivityTimestamp);
