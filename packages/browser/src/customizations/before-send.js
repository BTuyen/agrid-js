import { includes, clampToRange } from '@agrid/core';
    ...
    return (captureResult) => {
        ...
        return number * 100 < clampToRange(percent * 100, 0, 100, logger)
            ? {
                ...
                properties: {
                    ...captureResult.properties,
                    $sample_type: appendArray((_a = captureResult.properties) === null || _a === void 0 ? void 0 : _a.$sample_type, 'sampleByEvent'),
                    $sample_threshold: updateThreshold((_b = captureResult.properties) === null || _b === void 0 ? void 0 : _b.$sample_threshold, percent),
                    $sampled_events: appendArray((_c = captureResult.properties) === null || _c === void 0 ? void 0 : _c.$sampled_events, eventNames),
                },
            }
            : null;
    };
}
export const printAndDropEverything = (result) => {
