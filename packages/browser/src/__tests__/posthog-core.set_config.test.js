...
describe('posthog.set_config', () => {
    ...
    describe('debug flag behavior', () => {
        ...
        ])('should set debug to $setValue when initially $initial', ({ initial, setValue, expectedDebug, expectedStorage }) => {
            const token = uuidv7();
    ...
    describe('persistence configuration', () => {
        ...
        it.each([{ persistenceType: 'sessionStorage' }, { persistenceType: 'memory' }])('should keep session persistence same as persistence for $persistenceType', ({ persistenceType }) => {
            const token = uuidv7();
