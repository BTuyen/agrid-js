...
describe('request', () => {
    ...
    const mockedXMLHttpRequest = XMLHttpRequest;
    ...
    describe('xhr', () => {
        ...
        it('performs the request with default params', () => {
            ...
            expect(mockedXHR.open).toHaveBeenCalledWith('GET', 'https://any.posthog-instance.com/?_=1700000000000&ver=1.23.45', true);
        ...
        it('calls the on callback handler when successful', async () => {
            ...
            request(createRequest());
            (_a = mockedXHR.onreadystatechange) === null || _a === void 0 ? void 0 : _a.call(mockedXHR, {});
    ...
    describe('fetch', () => {
        ...
        it('performs the request with default params', () => {
            ...
            expect(mockedFetch).toHaveBeenCalledWith(`https://any.posthog-instance.com?ver=1.23.45&_=1700000000000`, expect.objectContaining({
                body: undefined,
                headers: new Headers(),
                keepalive: false,
                method: 'GET',
        ...
        it('supports nextOptions parameter', async () => {
            ...
            await flushPromises();
            expect(mockedFetch).toHaveBeenCalledWith(expect.anything(), expect.objectContaining({
                cache: 'force-cache',
        ...
        describe('keepalive with fetch and large bodies can cause some browsers to reject network calls', () => {
            it.each([
            ...
            ])(`uses keep alive: %s`, (_name, method, body, compression, expectedKeepAlive, expectedURLParams) => {
                request(createRequest({
                    headers: {
                        'x-header': 'value',
                    },
                ...
                expect(mockedFetch).toHaveBeenCalledWith(`https://any.posthog-instance.com?ver=1.23.45&_=1700000000000${expectedURLParams}`, expect.objectContaining({
                    headers: new Headers(),
        ...
        describe('adding query params to posthog API calls', () => {
            ...
            ])('%s', (_name, url, params, replace, expectedUrl) => {
        ...
        describe('body encoding', () => {
            ...
            it('should gzip compress data if set', async () => {
                ...
                   "
            `);
                expect(mockedXHR.setRequestHeader).not.toHaveBeenCalledWith('Content-Type', 'application/x-www-form-urlencoded');
            });
            it('converts bigint properties to string without throwing', () => {
                ...
                expect(mockedXHR.send.mock.calls[0][0]).toMatchInlineSnapshot(`"data=eyJmb28iOiI5OTk5OTk5OTk5OTk5OTk5OTk5OTkifQ%3D%3D"`);
                expect(mockedXHR.setRequestHeader).toHaveBeenCalledWith('Content-Type', 'application/x-www-form-urlencoded');
            });
        });
        describe('sendBeacon', () => {
            ...
            it("should encode data to a string and send it as a blob if it's a POST request", async () => {
                ...
                expect(mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon).toHaveBeenCalledWith('https://any.posthog-instance.com/?_=1700000000000&ver=1.23.45&beacon=1', expect.any(Blob));
                const blob = mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon.mock.calls[0][1];
                const reader = new FileReader();
            ...
            it('should respect base64 compression', async () => {
                ...
                expect(mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon).toHaveBeenCalledWith('https://any.posthog-instance.com/?_=1700000000000&ver=1.23.45&compression=base64&beacon=1', expect.any(Blob));
                const blob = mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon.mock.calls[0][1];
                const reader = new FileReader();
                const result = await new Promise((resolve) => {
                    reader.onload = () => resolve(reader.result);
            ...
            it('should respect gzip compression', async () => {
                ...
                expect(mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon).toHaveBeenCalledWith('https://any.posthog-instance.com/?_=1700000000000&ver=1.23.45&compression=gzip-js&beacon=1', expect.any(Blob));
                const blob = mockedNavigator === null || mockedNavigator === void 0 ? void 0 : mockedNavigator.sendBeacon.mock.calls[0][1];
                const reader = new FileReader();
                const result = await new Promise((resolve) => {
                    reader.onload = () => resolve(reader.result);
