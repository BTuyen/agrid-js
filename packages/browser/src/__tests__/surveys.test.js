...
import { canActivateRepeatedly, getDisplayOrderChoices, getDisplayOrderQuestions, } from '../extensions/surveys/surveys-extension-utils';
...
describe('surveys', () => {
    ...
    const surveysWithFeatureFlagKeys = [
        {
    ...
    beforeEach(() => {
        ...
        instance = {
            ...
            register: (props) => { var _a; return (_a = instance.persistence) === null || _a === void 0 ? void 0 : _a.register(props); },
            unregister: (key) => { var _a; return (_a = instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(key); },
            get_property: (key) => { var _a; return (_a = instance.persistence) === null || _a === void 0 ? void 0 : _a.props[key]; },
            _send_request: jest
                .fn()
    ...
    it('getSurveys gets a list of surveys if not present already', () => {
        ...
        expect((_a = instance.persistence) === null || _a === void 0 ? void 0 : _a.props.$surveys).toEqual(firstSurveys);
    ...
    it('getSurveys registers the survey event receiver if a survey has events', () => {
        ...
        const registry = (_a = surveys._surveyEventReceiver) === null || _a === void 0 ? void 0 : _a.getEventToSurveys();
    ...
    it('getSurveys force reloads when called with true', () => {
        ...
        expect((_b = instance.persistence) === null || _b === void 0 ? void 0 : _b.props.$surveys).toEqual(secondSurveys);
    ...
    describe('getActiveMatchingSurveys', () => {
        ...
        const surveyWithMobileDeviceType = {
        ...
        const surveyWithUrlDoesNotContainRegex = {
        ...
        const surveyWithUrlDoesNotContain = {
        ...
        const surveyWithEnabledInternalFlag = {
        ...
        const surveyWithDisabledInternalFlag = {
        ...
        it('returns surveys based on url and selector matching', () => {
            ...
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://posthog.com');
            surveys.getActiveMatchingSurveys((data) => {
            ...
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://posthogapp.com');
        ...
        it('returns surveys based on url with urlMatchType settings', () => {
            ...
            const originalWindowLocation = assignableWindow.location;
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://regex-url.com/test');
            surveys.getActiveMatchingSurveys((data) => {
                expect(data).toEqual([surveyWithRegexUrl]);
            });
            assignableWindow.location = originalWindowLocation;
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://example.com?name=something');
            surveys.getActiveMatchingSurveys((data) => {
                expect(data).toEqual([surveyWithParamRegexUrl]);
            });
            assignableWindow.location = originalWindowLocation;
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://app.subdomain.com');
            surveys.getActiveMatchingSurveys((data) => {
                expect(data).toEqual([surveyWithWildcardSubdomainUrl]);
            });
            assignableWindow.location = originalWindowLocation;
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://wildcard.com/something/other');
            surveys.getActiveMatchingSurveys((data) => {
                expect(data).toEqual([surveyWithWildcardRouteUrl]);
            });
            assignableWindow.location = originalWindowLocation;
            // eslint-disable-next-line compat/compat
            assignableWindow.location = new URL('https://example.com/exact');
            surveys.getActiveMatchingSurveys((data) => {
        ...
        it('returns surveys based on device types matching', () => {
            ...
            const userAgent = 'Mozilla/5.0 (Linux; U; Android-4.0.3; en-us; Galaxy Nexus Build/IML74K) AppleWebKit/535.7 (KHTML, like Gecko) CrMo/16.0.912.75 Mobile Safari/535.7';
        ...
        it('returns event based surveys that observed an event', () => {
            ...
            (_a = surveys._surveyEventReceiver) === null || _a === void 0 ? void 0 : _a.on('user_subscribed');
            surveys.getActiveMatchingSurveys((data) => {
                expect(data).toEqual([surveyWithEnabledInternalFlag]);
            });
        });
    ...
    describe('renderSurvey', () => {
        ...
        it('should render in-app surveys (popover, widget, api)', () => {
            ...
            surveys._surveyManager = { renderSurvey: mockRenderSurvey };
        ...
        it('should warn when survey is not found', () => {
            ...
            surveys._surveyManager = { renderSurvey: jest.fn() };
            const loggerWarnSpy = jest.spyOn(logger, 'warn');
    ...
    describe('_isSurveyFeatureFlagEnabled', () => {
        ...
        beforeEach(() => {
            surveys.loadIfEnabled();
            surveyManager = surveys._surveyManager;
        });
    ...
    describe('shuffling questions', () => {
        const surveyWithoutShufflingQuestions = {
        ...
        const surveyWithShufflingQuestions = {
            name: 'survey without shuffling questions',
            description: 'survey without shuffling questions',
            type: SurveyType.Popover,
            questions: [
        ...
        it('should not shuffle questions if shuffleQuestions is false', () => {
            expect(surveyWithoutShufflingQuestions.questions).toEqual(getDisplayOrderQuestions(surveyWithoutShufflingQuestions));
        });
        it('should shuffle questions if shuffleQuestions is true', () => {
            expect(surveyWithShufflingQuestions.questions).not.toEqual(getDisplayOrderQuestions(surveyWithShufflingQuestions));
        });
        it('should be able to find the original question from its ID', () => {
            ...
            for (let i = 0; i < shuffledQuestions.length; i++) {
                const originalQuestion = surveyWithShufflingQuestions.questions.find((q) => q.id === shuffledQuestions[i].id);
                expect(shuffledQuestions[i].question).toEqual(originalQuestion === null || originalQuestion === void 0 ? void 0 : originalQuestion.question);
            }
        });
    ...
    describe('shuffling options', () => {
        const questionWithoutShufflingOptions = {
        ...
        const questionWithShufflingOptions = {
            type: SurveyQuestionType.MultipleChoice,
            question: "We're sorry to see you go. What's your reason for unsubscribing?",
            choices: [
                'I no longer need the product',
        ...
        const questionWithOpenEndedChoice = {
            type: SurveyQuestionType.MultipleChoice,
            question: "We're sorry to see you go. What's your reason for unsubscribing?",
            choices: [
                'I no longer need the product',
