...
import { MultipleChoiceQuestion, OpenTextQuestion, RatingQuestion, } from '../../../extensions/surveys/components/QuestionTypes';
...
describe('MultipleChoiceQuestion', () => {
    ...
    describe('SingleChoice', () => {
        ...
        it('submits the selected choice correctly', () => {
            const { getByLabelText, getByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: singleChoiceQuestion }));
        ...
        it('submits open-ended choice correctly', () => {
            const { getByText, container } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: singleChoiceQuestion }));
            ...
            const openInput = container.querySelector('#surveyQuestion1Choice3Open');
        ...
        it('focuses on open-ended input when selecting the option', () => {
            const { container, getByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: singleChoiceQuestion }));
            // Click on 'Other' option using the radio input id
            const otherRadio = getByText('Other:');
            fireEvent.click(otherRadio);
    ...
    describe('SingleChoice with skipSubmitButton', () => {
        const singleChoiceSkipQuestion = {
            type: SurveyQuestionType.SingleChoice,
            question: 'What is your favorite color?',
            description: 'Choose one color',
        ...
        it('submits the selected choice immediately and hides button', () => {
            ...
            const { getByLabelText, queryByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, onSubmit: onSubmitMock, question: singleChoiceSkipQuestion }));
        ...
        it('shows submit button if skipSubmitButton is false', () => {
            ...
            const { getByLabelText, queryByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: question }));
    ...
    describe('MultipleChoice', () => {
        ...
        it('submits multiple selected choices correctly', () => {
            const { getByLabelText, getByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: multipleChoiceQuestion }));
        ...
        it('submits multiple choices with open-ended choice correctly', () => {
            const { getByLabelText, getByText, container } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: multipleChoiceQuestion }));
        ...
        it('focuses on open-ended input when selecting the option', () => {
            const { container, getByText } = render(_jsx(MultipleChoiceQuestion, { ...baseProps, question: multipleChoiceQuestion }));
            // Click on 'Other' option using the radio input id
            const otherRadio = getByText('Other:');
            fireEvent.click(otherRadio);
            // Get the input element using its specific id
        ...
        it('does not propagate keydown events from open choice input', () => {
            ...
            const { container } = render(_jsx("div", { onKeyDown: parentKeyDownHandler, children: _jsx(MultipleChoiceQuestion, { ...baseProps, question: multipleChoiceQuestion }) }));
...
describe('OpenTextQuestion', () => {
    ...
    it('does not propagate keydown events', () => {
        ...
        const { container } = render(_jsx("div", { onKeyDown: parentKeyDownHandler, children: _jsx(OpenTextQuestion, { ...baseProps, question: openTextQuestion }) }));
...
describe('RatingQuestion', () => {
    ...
    const getRatingButton = (value) => {
        return screen.getByText(value.toString());
    };
    it('renders correctly with no initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: null }));
    ...
    it('renders correctly with a valid numeric initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: 3 }));
    ...
    it('renders correctly with a valid string initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: '4' }));
    ...
    it('renders correctly with a valid array initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: ['2'] }));
    ...
    it('renders correctly with an invalid string initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: 'invalid' }));
        const buttons = screen.getAllByRole('button');
        const ratingButtons = buttons.filter((btn) => btn.textContent !== mockAppearance.submitButtonText);
        ratingButtons.forEach((button) => {
            expect(button).not.toHaveClass('rating-active');
    ...
    it('renders correctly with an empty array initial value', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion, initialValue: [] }));
        const buttons = screen.getAllByRole('button');
        const ratingButtons = buttons.filter((btn) => btn.textContent !== mockAppearance.submitButtonText);
        ratingButtons.forEach((button) => {
            expect(button).not.toHaveClass('rating-active');
    ...
    const ratingQuestion10Scale = {
        ...ratingQuestion,
        scale: 10,
        description: 'Scale from 0 to 10',
    };
    it('renders 10-scale correctly with initial value 0', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion10Scale, initialValue: 0 }));
    ...
    it('renders 10-scale correctly with initial value 10', () => {
        render(_jsx(RatingQuestion, { ...baseProps, question: ratingQuestion10Scale, initialValue: '10' }));
    ...
    it('submit button is enabled initially if question is optional', () => {
        ...
        render(_jsx(RatingQuestion, { ...baseProps, question: optionalQuestion, initialValue: null }));
        const submitButton = screen.getByText(mockAppearance.submitButtonText);
    ...
    describe('RatingQuestion with skipSubmitButton', () => {
        ...
        const ratingEmojiSkipQuestion = {
            ...ratingSkipQuestion,
            display: 'emoji',
        };
        it('submits rating immediately and hides button for number display', async () => {
            const onSubmitMock = jest.fn();
            render(_jsx(RatingQuestion, { ...baseProps, onSubmit: onSubmitMock, question: ratingSkipQuestion }));
            const button3 = getRatingButton(3);
        ...
        it('submits rating immediately and hides button for emoji display', async () => {
            const onSubmitMock = jest.fn();
            render(_jsx(RatingQuestion, { ...baseProps, onSubmit: onSubmitMock, question: ratingEmojiSkipQuestion }));
        ...
        it('shows submit button if skipSubmitButton is false for number display', () => {
            ...
            const onSubmitMock = jest.fn();
            render(_jsx(RatingQuestion, { ...baseProps, onSubmit: onSubmitMock, question: question }));
            const button3 = getRatingButton(3);
            fireEvent.click(button3);
