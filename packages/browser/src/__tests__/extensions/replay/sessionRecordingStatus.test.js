import { ACTIVE, allMatchSessionRecordingStatus, anyMatchSessionRecordingStatus, BUFFERING, DISABLED, LinkedFlagMatching, PAUSED, SAMPLED, TRIGGER_ACTIVATED, TRIGGER_DISABLED, TRIGGER_PENDING, } from '../../../extensions/replay/external/triggerMatching';
const fakePostHog = { register_for_session: () => { } };
const defaultTriggersStatus = {
    receivedFlags: true,
...
const makeLinkedFlagMatcher = (linkedFlag, linkedFlagSeen) => {
