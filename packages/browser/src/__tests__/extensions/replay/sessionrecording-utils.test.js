import { ensureMaxMessageSize, replacementImageURI, truncateLargeConsoleLogs, CONSOLE_LOG_PLUGIN_NAME, PLUGIN_EVENT_TYPE, FULL_SNAPSHOT_EVENT_TYPE, splitBuffer, SEVEN_MEGABYTES, estimateSize, circularReferenceReplacer, } from '../../../extensions/replay/external/sessionrecording-utils';
...
describe(`SessionRecording utility functions`, () => {
    ...
    describe(`truncateLargeConsoleLogs`, () => {
        ...
        it(`should not touch non plugin objects`, () => {
            expect(truncateLargeConsoleLogs({
