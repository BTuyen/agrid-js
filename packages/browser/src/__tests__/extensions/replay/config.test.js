...
describe('config', () => {
    describe('network request options', () => {
        describe('maskRequestFn', () => {
            ...
            ])('ignores ingestion paths', (capturedRequest, expected, apiHost) => {
                const networkOptions = buildNetworkRequestOptions({ ...defaultConfig(), api_host: apiHost || 'https://us.posthog.com' }, {});
