...
describe('DeadClicksAutocapture', () => {
    ...
    beforeEach(() => {
        ...
        assignableWindow.__PosthogExtensions__.loadExternalDependency = jest
            .fn()
            .mockImplementation(() => (_ph, _name, cb) => {
            cb();
        });
    });
    ...
    it('should call loadExternalDependency if script is not already loaded', async () => {
        ...
        const mockLoader = assignableWindow.__PosthogExtensions__.loadExternalDependency;
    ...
    it('should call lazy loaded stop when stopping', async () => {
        ...
        const mockLazyStop = (_a = instance.deadClicksAutocapture.lazyLoadedDeadClicksAutocapture) === null || _a === void 0 ? void 0 : _a.stop;
    ...
    describe('config', () => {
        ...
        it.each([
            ...
            var _a;
            (_a = instance.persistence) === null || _a === void 0 ? void 0 : _a.register({
