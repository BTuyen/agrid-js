...
describe('HistoryAutocapture', () => {
    let posthog;
    let capture;
    let historyAutocapture;
    let originalPushState;
    let originalReplaceState;
    let pageViewManagerDoPageView;
    let scrollManagerResetContext;
    let mockLocation;
    beforeEach(() => {
    ...
    describe('Initialization and Configuration', () => {
        it('should initialize correctly', () => {
            ...
            expect(window.history.pushState.__posthog_wrapped__).toBe(true);
            expect(window.history.replaceState.__posthog_wrapped__).toBe(true);
        });
        ...
        it('should not setup event listeners if feature is disabled', () => {
            ...
            expect(window.history.pushState.__posthog_wrapped__).toBeUndefined();
            expect(window.history.replaceState.__posthog_wrapped__).toBeUndefined();
        });
