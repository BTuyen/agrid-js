import { canActivateRepeatedly, doesSurveyUrlMatch, getFontFamily, getSurveySeen, hasEvents, hasWaitPeriodPassed, } from '../../extensions/surveys/surveys-extension-utils';
...
describe('getSurveySeen', () => {
    ...
    describe('when survey has been seen', () => {
        ...
        it('should return false for survey that is in progress', () => {
            ...
            localStorage.setItem(`${SURVEY_IN_PROGRESS_PREFIX}${surveyInProgress.id}`, JSON.stringify({
    ...
    describe('with current_iteration', () => {
        it('should use iteration-specific key when current_iteration is set', () => {
            ...
            localStorage.setItem(`${SURVEY_SEEN_PREFIX}${surveyWithIteration.id}_${surveyWithIteration.current_iteration}`, 'true');
...
describe('getFontFamily', () => {
    it('should return the default font family with fallbacks when no font family is provided', () => {
        expect(getFontFamily()).toBe('-apple-system, BlinkMacSystemFont, "Inter", "Segoe UI", "Roboto", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"');
    });
    it('should return the provided font family with fallbacks when a custom font family is provided', () => {
        expect(getFontFamily('Arial')).toBe('Arial, BlinkMacSystemFont, "Inter", "Segoe UI", "Roboto", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"');
    });
