...
describe('loaded() with flags', () => {
    ...
    const createPosthog = async (config) => {
        const posthog = await createPosthogInstance(uuidv7(), {
            ...
            loaded: (ph) => {
                var _a;
                ph.capture = jest.fn();
                ph._send_request = jest.fn(({ callback }) => callback === null || callback === void 0 ? void 0 : callback({ statusCode: 200, json: {} }));
                ...
                (_a = config === null || config === void 0 ? void 0 : config.loaded) === null || _a === void 0 ? void 0 : _a.call(config, ph);
            },
        });
        return posthog;
    };
    describe('replay', () => {
        it('can set force allow localhost network capture', async () => {
            ...
            expect((_a = instance.sessionRecording) === null || _a === void 0 ? void 0 : _a._forceAllowLocalhostNetworkCapture).toBe(true);
        });
    });
    ...
    describe('quota limiting', () => {
        ...
        it.each([
            ...
            instance._send_request = jest.fn(({ callback }) => callback === null || callback === void 0 ? void 0 : callback({
                statusCode: 200,
                json: response,
            }));
