...
import { getSafeText, shouldCaptureDomEvent, shouldCaptureElement, isSensitiveElement, shouldCaptureValue, isAngularStyleAttr, getNestedSpanText, getDirectAndNestedSpanText, getElementsChainString, getClassNames, makeSafeText, } from '../autocapture-utils';
...
describe(`Autocapture utility functions`, () => {
            ...
            testStrings.forEach((str) => {
                ...
                if (str.trim().length > 0) {
                    ...
                    if (str.includes('"') || str.includes("'")) {
                        ...
                        const hasQuotes = (result === null || result === void 0 ? void 0 : result.includes('"')) || (result === null || result === void 0 ? void 0 : result.includes("'"));
    ...
    describe(`shouldCaptureDomEvent`, () => {
        ...
        it(`should protect against bad inputs`, () => {
            expect(shouldCaptureDomEvent(null, makeMouseEvent({}))).toBe(false);
            expect(shouldCaptureDomEvent(undefined, makeMouseEvent({}))).toBe(false);
            expect(shouldCaptureDomEvent(`div`, makeMouseEvent({}))).toBe(false);
        });
        ...
        describe('css selector allowlist', () => {
            function makeSingleBranchOfDomTree(tree) {
    ...
    describe(`getDirectAndNestedSpanText`, () => {
        ...
        it(`should properly handle complex titles with multiple quotes`, () => {
            ...
            expect(getDirectAndNestedSpanText(link)).toBe(`Course Title: "Understanding the 'Creative Process' in Modern Design"`);
            ...
            expect(link.getAttribute('title')).toBe(`Course Title: "Understanding the 'Creative Process' in Modern Design"`);
        });
    ...
    describe('getElementsChainString', () => {
        ...
        it('should properly escape quotation marks in elements', () => {
            ...
            expect(elementChain).toContain('text="Course Title: \\"Understanding the \'Creative Process\' in Modern Design\\""');
        });
