...
describe('Web Experimentation', () => {
    ...
    const simulateFeatureFlags = jest.fn();
    beforeEach(() => {
        let cachedFlags = {};
    ...
    function testUrlMatch(testLocation, expectedInnerHTML) {
        experimentsResponse = {
    ...
    describe('with feature flags', () => {
        ...
        it('can render previews based on URL params', () => {
            ...
            WebExperiments.getWindowLocation = () => {
                // eslint-disable-next-line compat/compat
                return new URL('https://example.com/landing-page?__experiment_id=3&__experiment_variant=variant-sign-up');
            };
