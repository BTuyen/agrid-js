...
describe('survey-event-receiver', () => {
    describe('event based surveys', () => {
        ...
        it('receiver removes survey from list after its shown', () => {
            ...
            if (firstSurvey.conditions && ((_a = firstSurvey.conditions) === null || _a === void 0 ? void 0 : _a.events)) {
    ...
    describe('property filter based surveys', () => {
        ...
        let instance;
        let mockAddCaptureHook;
        const createEventPayload = (eventName, properties = {}) => ({
            $set: undefined,
            $set_once: undefined,
            event: eventName,
            timestamp: undefined,
        ...
        const createSurveyWithPropertyFilters = (id, eventName, propertyFilters) => ({
            name: `${id} survey`,
            id,
        ...
        it('activates survey with exact property match', () => {
            ...
            const registeredHook = mockAddCaptureHook.mock.calls[0][0];
            instance.getSurveys.mockImplementation((callback) => callback([survey]));
    ...
    describe('action based surveys', () => {
        ...
        const autoCaptureSurvey = {
            ...
            questions: [{ type: SurveyQuestionType.Open, question: 'what is a bokoblin?' }],
            conditions: {
                actions: [createAction(2, '$autocapture')],
            },
        };
        const pageViewSurvey = {
            ...
            questions: [{ type: SurveyQuestionType.Open, question: 'what is a bokoblin?' }],
            conditions: {
                actions: [createAction(3, '$pageview')],
            },
        };
        it('can match action on event name', () => {
            const myPageViewSurvey = {
                ...
                conditions: {
                    actions: {
                        values: [createAction(3, '$mypageview')],
                    },
                },
            };
