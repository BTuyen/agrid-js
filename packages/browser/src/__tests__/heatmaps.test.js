...
describe('heatmaps', () => {
    ...
    beforeEach(async () => {
        ...
        posthog = await createPosthogInstance(uuidv7(), {
            ...
            sanitize_properties: (props) => {
                ...
                const sanitizeUrl = (url) => url.replace(/https?:\/\/[^/]+/g, 'http://replaced');
    ...
    it('should send generated heatmap data', async () => {
        var _a, _b;
        (_b = (_a = posthog.heatmaps) === null || _a === void 0 ? void 0 : _a['_onClick']) === null || _b === void 0 ? void 0 : _b.call(_a, createMockMouseEvent());
    ...
    it('should handle empty mouse moves', async () => {
        var _a, _b;
        (_b = (_a = posthog.heatmaps) === null || _a === void 0 ? void 0 : _a['_onMouseMove']) === null || _b === void 0 ? void 0 : _b.call(_a, new Event('mousemove'));
        jest.advanceTimersByTime(posthog.heatmaps.flushIntervalMilliseconds + 1);
        expect(beforeSendMock).toBeCalledTimes(0);
    });
    it('should send rageclick events in the same area', async () => {
        ...
        (_b = (_a = posthog.heatmaps) === null || _a === void 0 ? void 0 : _a['_onClick']) === null || _b === void 0 ? void 0 : _b.call(_a, createMockMouseEvent());
        (_d = (_c = posthog.heatmaps) === null || _c === void 0 ? void 0 : _c['_onClick']) === null || _d === void 0 ? void 0 : _d.call(_c, createMockMouseEvent());
        (_f = (_e = posthog.heatmaps) === null || _e === void 0 ? void 0 : _e['_onClick']) === null || _f === void 0 ? void 0 : _f.call(_e, createMockMouseEvent());
        jest.advanceTimersByTime(posthog.heatmaps.flushIntervalMilliseconds + 1);
        expect(beforeSendMock).toBeCalledTimes(1);
    ...
    it('should ignore clicks if they come from the toolbar', async () => {
        ...
        expect((_c = posthog.heatmaps) === null || _c === void 0 ? void 0 : _c['buffer']).toEqual(undefined);
        const testElementClosest = document.createElement('div');
        testElementClosest.closest = () => {
            return {};
        };
        (_e = (_d = posthog.heatmaps) === null || _d === void 0 ? void 0 : _d['_onClick']) === null || _e === void 0 ? void 0 : _e.call(_d, createMockMouseEvent({
            target: testElementClosest,
        }));
        expect((_f = posthog.heatmaps) === null || _f === void 0 ? void 0 : _f['buffer']).toEqual(undefined);
        (_h = (_g = posthog.heatmaps) === null || _g === void 0 ? void 0 : _g['_onClick']) === null || _h === void 0 ? void 0 : _h.call(_g, createMockMouseEvent({
            target: document.body,
        }));
        expect((_j = posthog.heatmaps) === null || _j === void 0 ? void 0 : _j.getAndClearBuffer()).not.toEqual(undefined);
        expect(beforeSendMock.mock.calls).toEqual([]);
    });
    it('should ignore an empty buffer', async () => {
        var _a;
        expect(beforeSendMock.mock.calls).toEqual([]);
        expect((_a = posthog.heatmaps) === null || _a === void 0 ? void 0 : _a['buffer']).toEqual(undefined);
        jest.advanceTimersByTime(posthog.heatmaps.flushIntervalMilliseconds + 1);
        expect(beforeSendMock.mock.calls).toEqual([]);
    });
    describe('isEnabled()', () => {
        ...
        it.each([
            ...
            [true, true, true, true],
        ])('when deprecated client side config is %p, current client side config is %p, and remote opt in is %p - heatmaps enabled should be %p', (deprecatedclientSideOptIn, clientSideOptIn, serverSideOptIn, expected) => {
    ...
    it('starts dead clicks autocapture with the correct config', () => {
        ...
        expect(JSON.stringify(heatmapsDeadClicksInstance.onCapture)).toEqual(JSON.stringify(posthog.heatmaps['_onDeadClick'].bind(posthog.heatmaps)));
    });
    describe.each([
    ...
    ])('the behaviour when mask_personal_data_properties is %s and custom_personal_data_properties is %s', (maskPersonalDataProperties, customPersonalDataProperties, maskedUrl) => {
        beforeEach(async () => {
            var _a, _b;
            beforeSendMock = beforeSendMock.mockClear();
            ...
            (_b = (_a = posthogWithMasking.heatmaps) === null || _a === void 0 ? void 0 : _a['_onClick']) === null || _b === void 0 ? void 0 : _b.call(_a, createMockMouseEvent());
