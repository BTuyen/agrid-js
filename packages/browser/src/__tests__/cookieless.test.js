...
describe('cookieless', () => {
    ...
    const setup = async (config = {}, token = uuidv7()) => {
    ...
    describe('always mode', () => {
        ...
        it.each([[true], ['history_change']])('should send the initial pageview event when capture_pageview is %p', async (capturePageview) => {
            const { posthog, beforeSendMock } = await setup({
                cookieless_mode: 'always',
