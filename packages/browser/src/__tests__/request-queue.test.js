...
describe('RequestQueue', () => {
    ...
    describe('with default config', () => {
        ...
        it('handles unload', () => {
            ...
            queue.enqueue({ url: '/e', data: { event: 'foo', timestamp: 1610000000 } });
            queue.enqueue({ url: '/identify', data: { event: '$identify', timestamp: 1620000000 } });
            queue.enqueue({ url: '/e', data: { event: 'bar', timestamp: 1630000000 } });
            queue.unload();
            expect(sendRequest).toHaveBeenCalledTimes(3);
        ...
        it('handles unload with batchKeys', () => {
            queue.enqueue({ url: '/e', data: { event: 'foo', timestamp: 1610000000 }, transport: 'XHR' });
            queue.enqueue({ url: '/identify', data: { event: '$identify', timestamp: 1620000000 } });
            queue.enqueue({ url: '/e', data: { event: 'bar', timestamp: 1630000000 } });
            queue.enqueue({
                url: '/e',
