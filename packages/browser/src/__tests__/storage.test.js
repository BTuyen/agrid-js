...
import { resetSessionStorageSupported, seekFirstNonPublicSubDomain, resetSubDomainCache, sessionStore, } from '../storage';
    ...
    describe('seekFirstNonPublicSubDomain', () => {
        ...
        const mockDocumentDotCookie = {
            ...
            set cookie(value) {
                ...
                if (['.uk', '.com', '.au', '.com.au', '.co.uk'].includes(domain))
                    return;
                this.value_ += value + ';';
            },
        };
