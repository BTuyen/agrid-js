...
const initPostHogInAPromise = (segment, posthogName, config) => {
    return new Promise((resolve) => {
        return new PostHog().init(`test-token`, {
            debug: true,
...
describe(`Segment integration`, () => {
    ...
    it('should handle segment.identify after bootstrap', async () => {
        ...
        expect((_a = posthog.persistence) === null || _a === void 0 ? void 0 : _a.get_property(USER_STATE)).toEqual('anonymous');
        if (segmentIntegration && segmentIntegration.identify) {
            ...
            expect((_b = posthog.persistence) === null || _b === void 0 ? void 0 : _b.get_property(USER_STATE)).toEqual('identified');
        }
    });
});
