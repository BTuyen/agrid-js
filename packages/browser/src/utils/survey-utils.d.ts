...
export declare const SURVEY_LOGGER: Omit<import("@agrid/core").Logger, "createLogger"> & {
    _log: (level: "log" | "warn" | "error", ...args: any[]) => void;
    uninitializedWarning: (methodName: string) => void;
    createLogger: (prefix: string) => Omit<import("@agrid/core").Logger, "createLogger"> & /*elided*/ any;
};
