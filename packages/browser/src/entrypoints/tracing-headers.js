...
const addTracingHeaders = (hostnames, distinctId, sessionManager, req) => {
    let reqHostname;
    try {
...
const patchFetch = (hostnames, distinctId, sessionManager) => {
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    return patch(window, 'fetch', (originalFetch) => {
...
const patchXHR = (hostnames, distinctId, sessionManager) => {
    return patch(
