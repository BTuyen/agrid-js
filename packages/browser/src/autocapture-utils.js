...
function checkForURLMatches(urlsList) {
    const url = window === null || window === void 0 ? void 0 : window.location.href;
...
function checkIfElementTreePassesElementAllowList(elements, autocaptureConfig) {
    const allowlist = autocaptureConfig === null || autocaptureConfig === void 0 ? void 0 : autocaptureConfig.element_allowlist;
...
function elementsToString(elements) {
    const ret = elements.map((element) => {
        ...
        const attributes = {
            ...
            'nth-child': (_a = element.nth_child) !== null && _a !== void 0 ? _a : 0,
            'nth-of-type': (_b = element.nth_of_type) !== null && _b !== void 0 ? _b : 0,
