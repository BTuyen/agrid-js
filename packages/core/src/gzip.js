 ...
 */
function gzipCompress(input_1) {
    return __awaiter(this, arguments, void 0, function (input, isDebug) {
        var dataStream, compressedStream, error_1;
        if (isDebug === void 0) { isDebug = true; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    dataStream = new Blob([input], {
                        type: 'text/plain',
                    }).stream();
                    compressedStream = dataStream.pipeThrough(new CompressionStream('gzip'));
                    return [4 /*yield*/, new Response(compressedStream).blob()];
                case 1: 
                ...
                case 2:
                    error_1 = _a.sent();
                    if (isDebug) {
                        console.error('Failed to gzip compress data', error_1);
                    }
